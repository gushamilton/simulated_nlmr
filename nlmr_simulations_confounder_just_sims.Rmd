...
f = list.files("zipped/required_functions/")

f
for(file in f){
  print(file)
  source(paste0("zipped/required_functions/",file))
}
...
map2(.x = analyses$exposures, .y = analyses$outcomes, seed = 2023, reps = 100, bux = 0.3, buy = 0.3, bgux = -0.1, covariates = "u_incomplete", u_cor = 0.8,.f = generate_outcome_plots_linear_replicates_confounder)
